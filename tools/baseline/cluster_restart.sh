...
echo "Server created"
#./loading.sh i
../../../redis/src/redis-benchmark -p 40001 -t hset -n 2000000 -r 100000000 -d 1000 -q -P 100 --cluster -c 1
mv ./redis-benchamrk.result ./redis-benchamrk.result_single_node_warm
