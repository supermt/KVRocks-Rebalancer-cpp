...
../../../redis/src/redis-benchmark -p 40001 -t hset -n 25531600 -r 100000000 -d 1000 -q -P 100 --cluster -c 2
mv ./redis-benchamrk.result ./redis-benchamrk.result_double_node_warm
