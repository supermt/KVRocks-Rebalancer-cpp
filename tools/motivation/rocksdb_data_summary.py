...
node1_logs = open("result_log/server_40001.log", "r").readlines()
node2_logs = open("result_log/server_40002.log", "r").readlines()

single_node_logs = open(
    "../baseline/single_result_log/server_40001.log", "r").readlines()
double_node1_logs = open(
    "../baseline/double_result_log/server_40001.log", "r").readlines()
double_node2_logs = open(
    "../baseline/double_result_log/server_40002.log", "r").readlines()
...
plt.plot(node1_qps_w[5:250], label="Node 1 (Migation Source)")
plt.plot(node2_qps_w[5:250], label="Node 2 (Migration Destination)")
...
plt.annotate('End of send snapshot', xy=(163, 35000), xytext=(75, 36000),
             arrowprops=dict(facecolor='#FFFFFF', edgecolor='red', shrink=0.01, linewidth=1), color='r')

plt.annotate('End of migration', xy=(238, 35000), xytext=(170, 36000),
             arrowprops=dict(facecolor='#FFFFFF', edgecolor='red', shrink=0.01, linewidth=1), color='r')
...
plt.tight_layout()
plt.savefig("qps-on-migration.pdf", bbox_inches='tight')

plt.cla()


plt.plot(double_node1_qps_w[5:250], linestyle="--", label="Node 1 (Baseline Sever 1)")
plt.plot(double_node2_qps_w[5:250], linestyle="--",  label="Node 2 (Baseline Server 2)")
...
plt.tight_layout()
plt.savefig("qps-baseline.pdf", bbox_inches='tight')


plt.cla()


plt.plot(node1_hit_r[5:250], label="Node 1 (Migation Source)")
plt.plot(node2_hit_r[5:250], label="Node 2 (Migation Destination)")

plt.plot(double_node1_hit_r[5:250], linestyle="--", label="Node 1 (Baseline Server 1)")
plt.plot(double_node2_hit_r[5:250], linestyle="--",  label="Node 2 (Baseline Server 2)")
...
plt.tight_layout()
plt.savefig("hit-ratio.pdf", bbox_inches='tight')


# plt.plot(node1_qps_r[5:250], label="Node 1 (with migration)")
# plt.plot(node2_qps_r[5:250], label="Node 2 (with migration)")
# plt.plot(double_node1_qps_r[5:250],linestyle="--", label="Node 1 (baseline)")
# plt.plot(double_node2_qps_r[5:250],linestyle="--",  label="Node 2 (baseline)")
...
# plt.tight_layout()
# plt.savefig("qps-r.pdf", bbox_inches='tight')
