...
redis-cli -h 127.0.0.1 -p 40001 stats > rocks_stat/$1/after_run.node1.stat
redis-cli -h 127.0.0.1 -p 40002 stats > rocks_stat/$1/after_run.node2.stat
redis-cli -h 127.0.0.1 -p 40003 stats > rocks_stat/$1/after_run.node3.stat
